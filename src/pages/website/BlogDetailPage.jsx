  ...
  return (
    <div style={{ background: darkMode ? '#080B13' : '#FBFBF9', color: darkMode ? '#F8FAFC' : '#0F172A', minHeight: '100vh', overflowX: 'hidden', transition: 'background-color 0.3s ease, color 0.3s ease' }}>
      ...
      <section style={{
        ...
        <Link to="/blog" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, fontSize: 13, fontWeight: 700, color: darkMode ? '#94A3B8' : '#64748B', textDecoration: 'none', marginBottom: 32 }}>
          <ArrowLeft size={16} />
          <span>Back to all articles</span>
        </Link>

        <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.15em', color: darkMode ? '#38BDF8' : '#2563EB', textTransform: 'uppercase', marginBottom: 12 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16, fontSize: 13, color: darkMode ? '#94A3B8' : '#64748B', marginBottom: 40, borderBottom: darkMode ? '1px solid rgba(255,255,255,0.1)' : '1px solid #E2E8F0', paddingBottom: 20 }}>
        ...
        <div style={{ fontSize: 16, color: darkMode ? '#CBD5E1' : '#334155', lineHeight: 1.8, display: 'flex', flexDirection: 'column', gap: 24 }}>
          <p>
          ...
          <h2 style={{ fontSize: 24, fontWeight: 700, color: darkMode ? '#F8FAFC' : '#0F172A', marginTop: 12 }}>
          ...
          <div style={{ background: darkMode ? '#131B2E' : '#ffffff', border: darkMode ? '1px solid rgba(255, 255, 255, 0.08)' : '1px solid #E2E8F0', borderRadius: 20, padding: 28, margin: '16px 0' }}>
            <h3 style={{ fontSize: 18, fontWeight: 700, color: darkMode ? '#F8FAFC' : '#0F172A', marginBottom: 12 }}>
